...
if __name__ == '__main__':
    ...
    parser.add_argument('--image_dir', type=str, default='data/dress',
                        help='directory for train images')
    parser.add_argument('--output_dir', type=str, default='/home/code-base/scratch_space/shoes_dataset/shoes_images_resized',
